...
module system_mm_interconnect_0 (
		...
		input  wire        audio_codec_reset_reset_bridge_in_reset_reset,   //  audio_codec_reset_reset_bridge_in_reset.reset
		...
		output wire [1:0]  audio_codec_avalon_audio_slave_address,          //           audio_codec_avalon_audio_slave.address
		output wire        audio_codec_avalon_audio_slave_write,            //                                         .write
		output wire        audio_codec_avalon_audio_slave_read,             //                                         .read
		input  wire [31:0] audio_codec_avalon_audio_slave_readdata,         //                                         .readdata
		output wire [31:0] audio_codec_avalon_audio_slave_writedata,        //                                         .writedata
		output wire        audio_codec_avalon_audio_slave_chipselect,       //                                         .chipselect
		...
		output wire [1:0]  sseg_i_iv_s1_address,                            //                             sseg_i_iv_s1.address
		output wire        sseg_i_iv_s1_write,                              //                                         .write
		input  wire [31:0] sseg_i_iv_s1_readdata,                           //                                         .readdata
		output wire [31:0] sseg_i_iv_s1_writedata,                          //                                         .writedata
		output wire        sseg_i_iv_s1_chipselect,                         //                                         .chipselect
		output wire [1:0]  sseg_v_vi_s1_address,                            //                             sseg_v_vi_s1.address
		output wire        sseg_v_vi_s1_write,                              //                                         .write
		input  wire [31:0] sseg_v_vi_s1_readdata,                           //                                         .readdata
		output wire [31:0] sseg_v_vi_s1_writedata,                          //                                         .writedata
		output wire        sseg_v_vi_s1_chipselect,                         //                                         .chipselect
	...
	wire  [31:0] audio_codec_avalon_audio_slave_agent_m0_readdata;                                   // audio_codec_avalon_audio_slave_translator:uav_readdata -> audio_codec_avalon_audio_slave_agent:m0_readdata
	wire         audio_codec_avalon_audio_slave_agent_m0_waitrequest;                                // audio_codec_avalon_audio_slave_translator:uav_waitrequest -> audio_codec_avalon_audio_slave_agent:m0_waitrequest
	wire         audio_codec_avalon_audio_slave_agent_m0_debugaccess;                                // audio_codec_avalon_audio_slave_agent:m0_debugaccess -> audio_codec_avalon_audio_slave_translator:uav_debugaccess
	wire  [20:0] audio_codec_avalon_audio_slave_agent_m0_address;                                    // audio_codec_avalon_audio_slave_agent:m0_address -> audio_codec_avalon_audio_slave_translator:uav_address
	wire   [3:0] audio_codec_avalon_audio_slave_agent_m0_byteenable;                                 // audio_codec_avalon_audio_slave_agent:m0_byteenable -> audio_codec_avalon_audio_slave_translator:uav_byteenable
	wire         audio_codec_avalon_audio_slave_agent_m0_read;                                       // audio_codec_avalon_audio_slave_agent:m0_read -> audio_codec_avalon_audio_slave_translator:uav_read
	wire         audio_codec_avalon_audio_slave_agent_m0_readdatavalid;                              // audio_codec_avalon_audio_slave_translator:uav_readdatavalid -> audio_codec_avalon_audio_slave_agent:m0_readdatavalid
	wire         audio_codec_avalon_audio_slave_agent_m0_lock;                                       // audio_codec_avalon_audio_slave_agent:m0_lock -> audio_codec_avalon_audio_slave_translator:uav_lock
	wire  [31:0] audio_codec_avalon_audio_slave_agent_m0_writedata;                                  // audio_codec_avalon_audio_slave_agent:m0_writedata -> audio_codec_avalon_audio_slave_translator:uav_writedata
	wire         audio_codec_avalon_audio_slave_agent_m0_write;                                      // audio_codec_avalon_audio_slave_agent:m0_write -> audio_codec_avalon_audio_slave_translator:uav_write
	wire   [2:0] audio_codec_avalon_audio_slave_agent_m0_burstcount;                                 // audio_codec_avalon_audio_slave_agent:m0_burstcount -> audio_codec_avalon_audio_slave_translator:uav_burstcount
	wire         audio_codec_avalon_audio_slave_agent_rf_source_valid;                               // audio_codec_avalon_audio_slave_agent:rf_source_valid -> audio_codec_avalon_audio_slave_agent_rsp_fifo:in_valid
	wire  [99:0] audio_codec_avalon_audio_slave_agent_rf_source_data;                                // audio_codec_avalon_audio_slave_agent:rf_source_data -> audio_codec_avalon_audio_slave_agent_rsp_fifo:in_data
	wire         audio_codec_avalon_audio_slave_agent_rf_source_ready;                               // audio_codec_avalon_audio_slave_agent_rsp_fifo:in_ready -> audio_codec_avalon_audio_slave_agent:rf_source_ready
	wire         audio_codec_avalon_audio_slave_agent_rf_source_startofpacket;                       // audio_codec_avalon_audio_slave_agent:rf_source_startofpacket -> audio_codec_avalon_audio_slave_agent_rsp_fifo:in_startofpacket
	wire         audio_codec_avalon_audio_slave_agent_rf_source_endofpacket;                         // audio_codec_avalon_audio_slave_agent:rf_source_endofpacket -> audio_codec_avalon_audio_slave_agent_rsp_fifo:in_endofpacket
	wire         audio_codec_avalon_audio_slave_agent_rsp_fifo_out_valid;                            // audio_codec_avalon_audio_slave_agent_rsp_fifo:out_valid -> audio_codec_avalon_audio_slave_agent:rf_sink_valid
	wire  [99:0] audio_codec_avalon_audio_slave_agent_rsp_fifo_out_data;                             // audio_codec_avalon_audio_slave_agent_rsp_fifo:out_data -> audio_codec_avalon_audio_slave_agent:rf_sink_data
	wire         audio_codec_avalon_audio_slave_agent_rsp_fifo_out_ready;                            // audio_codec_avalon_audio_slave_agent:rf_sink_ready -> audio_codec_avalon_audio_slave_agent_rsp_fifo:out_ready
	wire         audio_codec_avalon_audio_slave_agent_rsp_fifo_out_startofpacket;                    // audio_codec_avalon_audio_slave_agent_rsp_fifo:out_startofpacket -> audio_codec_avalon_audio_slave_agent:rf_sink_startofpacket
	wire         audio_codec_avalon_audio_slave_agent_rsp_fifo_out_endofpacket;                      // audio_codec_avalon_audio_slave_agent_rsp_fifo:out_endofpacket -> audio_codec_avalon_audio_slave_agent:rf_sink_endofpacket
	wire         audio_codec_avalon_audio_slave_agent_rdata_fifo_src_valid;                          // audio_codec_avalon_audio_slave_agent:rdata_fifo_src_valid -> audio_codec_avalon_audio_slave_agent_rdata_fifo:in_valid
	wire  [33:0] audio_codec_avalon_audio_slave_agent_rdata_fifo_src_data;                           // audio_codec_avalon_audio_slave_agent:rdata_fifo_src_data -> audio_codec_avalon_audio_slave_agent_rdata_fifo:in_data
	wire         audio_codec_avalon_audio_slave_agent_rdata_fifo_src_ready;                          // audio_codec_avalon_audio_slave_agent_rdata_fifo:in_ready -> audio_codec_avalon_audio_slave_agent:rdata_fifo_src_ready
	wire         cmd_mux_src_valid;                                                                  // cmd_mux:src_valid -> audio_codec_avalon_audio_slave_agent:cp_valid
	wire  [98:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> audio_codec_avalon_audio_slave_agent:cp_data
	wire         cmd_mux_src_ready;                                                                  // audio_codec_avalon_audio_slave_agent:cp_ready -> cmd_mux:src_ready
	wire   [8:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> audio_codec_avalon_audio_slave_agent:cp_channel
	wire         cmd_mux_src_startofpacket;                                                          // cmd_mux:src_startofpacket -> audio_codec_avalon_audio_slave_agent:cp_startofpacket
	wire         cmd_mux_src_endofpacket;                                                            // cmd_mux:src_endofpacket -> audio_codec_avalon_audio_slave_agent:cp_endofpacket
	...
	wire  [98:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> sysid_qsys_0_control_slave_agent:cp_data
	...
	wire  [98:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> nios2_gen2_0_debug_mem_slave_agent:cp_data
	...
	wire  [98:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> onchip_memory2_0_s1_agent:cp_data
	...
	wire  [98:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> buttons_s1_agent:cp_data
	...
	wire  [31:0] sseg_i_iv_s1_agent_m0_readdata;                                                     // sseg_i_iv_s1_translator:uav_readdata -> sseg_i_iv_s1_agent:m0_readdata
	wire         sseg_i_iv_s1_agent_m0_waitrequest;                                                  // sseg_i_iv_s1_translator:uav_waitrequest -> sseg_i_iv_s1_agent:m0_waitrequest
	wire         sseg_i_iv_s1_agent_m0_debugaccess;                                                  // sseg_i_iv_s1_agent:m0_debugaccess -> sseg_i_iv_s1_translator:uav_debugaccess
	wire  [20:0] sseg_i_iv_s1_agent_m0_address;                                                      // sseg_i_iv_s1_agent:m0_address -> sseg_i_iv_s1_translator:uav_address
	wire   [3:0] sseg_i_iv_s1_agent_m0_byteenable;                                                   // sseg_i_iv_s1_agent:m0_byteenable -> sseg_i_iv_s1_translator:uav_byteenable
	wire         sseg_i_iv_s1_agent_m0_read;                                                         // sseg_i_iv_s1_agent:m0_read -> sseg_i_iv_s1_translator:uav_read
	wire         sseg_i_iv_s1_agent_m0_readdatavalid;                                                // sseg_i_iv_s1_translator:uav_readdatavalid -> sseg_i_iv_s1_agent:m0_readdatavalid
	wire         sseg_i_iv_s1_agent_m0_lock;                                                         // sseg_i_iv_s1_agent:m0_lock -> sseg_i_iv_s1_translator:uav_lock
	wire  [31:0] sseg_i_iv_s1_agent_m0_writedata;                                                    // sseg_i_iv_s1_agent:m0_writedata -> sseg_i_iv_s1_translator:uav_writedata
	wire         sseg_i_iv_s1_agent_m0_write;                                                        // sseg_i_iv_s1_agent:m0_write -> sseg_i_iv_s1_translator:uav_write
	wire   [2:0] sseg_i_iv_s1_agent_m0_burstcount;                                                   // sseg_i_iv_s1_agent:m0_burstcount -> sseg_i_iv_s1_translator:uav_burstcount
	wire         sseg_i_iv_s1_agent_rf_source_valid;                                                 // sseg_i_iv_s1_agent:rf_source_valid -> sseg_i_iv_s1_agent_rsp_fifo:in_valid
	wire  [99:0] sseg_i_iv_s1_agent_rf_source_data;                                                  // sseg_i_iv_s1_agent:rf_source_data -> sseg_i_iv_s1_agent_rsp_fifo:in_data
	wire         sseg_i_iv_s1_agent_rf_source_ready;                                                 // sseg_i_iv_s1_agent_rsp_fifo:in_ready -> sseg_i_iv_s1_agent:rf_source_ready
	wire         sseg_i_iv_s1_agent_rf_source_startofpacket;                                         // sseg_i_iv_s1_agent:rf_source_startofpacket -> sseg_i_iv_s1_agent_rsp_fifo:in_startofpacket
	wire         sseg_i_iv_s1_agent_rf_source_endofpacket;                                           // sseg_i_iv_s1_agent:rf_source_endofpacket -> sseg_i_iv_s1_agent_rsp_fifo:in_endofpacket
	wire         sseg_i_iv_s1_agent_rsp_fifo_out_valid;                                              // sseg_i_iv_s1_agent_rsp_fifo:out_valid -> sseg_i_iv_s1_agent:rf_sink_valid
	wire  [99:0] sseg_i_iv_s1_agent_rsp_fifo_out_data;                                               // sseg_i_iv_s1_agent_rsp_fifo:out_data -> sseg_i_iv_s1_agent:rf_sink_data
	wire         sseg_i_iv_s1_agent_rsp_fifo_out_ready;                                              // sseg_i_iv_s1_agent:rf_sink_ready -> sseg_i_iv_s1_agent_rsp_fifo:out_ready
	wire         sseg_i_iv_s1_agent_rsp_fifo_out_startofpacket;                                      // sseg_i_iv_s1_agent_rsp_fifo:out_startofpacket -> sseg_i_iv_s1_agent:rf_sink_startofpacket
	wire         sseg_i_iv_s1_agent_rsp_fifo_out_endofpacket;                                        // sseg_i_iv_s1_agent_rsp_fifo:out_endofpacket -> sseg_i_iv_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> sseg_i_iv_s1_agent:cp_valid
	wire  [98:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> sseg_i_iv_s1_agent:cp_data
	wire         cmd_mux_007_src_ready;                                                              // sseg_i_iv_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> sseg_i_iv_s1_agent:cp_channel
	wire         cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> sseg_i_iv_s1_agent:cp_startofpacket
	wire         cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> sseg_i_iv_s1_agent:cp_endofpacket
	wire  [31:0] sseg_v_vi_s1_agent_m0_readdata;                                                     // sseg_v_vi_s1_translator:uav_readdata -> sseg_v_vi_s1_agent:m0_readdata
	wire         sseg_v_vi_s1_agent_m0_waitrequest;                                                  // sseg_v_vi_s1_translator:uav_waitrequest -> sseg_v_vi_s1_agent:m0_waitrequest
	wire         sseg_v_vi_s1_agent_m0_debugaccess;                                                  // sseg_v_vi_s1_agent:m0_debugaccess -> sseg_v_vi_s1_translator:uav_debugaccess
	wire  [20:0] sseg_v_vi_s1_agent_m0_address;                                                      // sseg_v_vi_s1_agent:m0_address -> sseg_v_vi_s1_translator:uav_address
	wire   [3:0] sseg_v_vi_s1_agent_m0_byteenable;                                                   // sseg_v_vi_s1_agent:m0_byteenable -> sseg_v_vi_s1_translator:uav_byteenable
	wire         sseg_v_vi_s1_agent_m0_read;                                                         // sseg_v_vi_s1_agent:m0_read -> sseg_v_vi_s1_translator:uav_read
	wire         sseg_v_vi_s1_agent_m0_readdatavalid;                                                // sseg_v_vi_s1_translator:uav_readdatavalid -> sseg_v_vi_s1_agent:m0_readdatavalid
	wire         sseg_v_vi_s1_agent_m0_lock;                                                         // sseg_v_vi_s1_agent:m0_lock -> sseg_v_vi_s1_translator:uav_lock
	wire  [31:0] sseg_v_vi_s1_agent_m0_writedata;                                                    // sseg_v_vi_s1_agent:m0_writedata -> sseg_v_vi_s1_translator:uav_writedata
	wire         sseg_v_vi_s1_agent_m0_write;                                                        // sseg_v_vi_s1_agent:m0_write -> sseg_v_vi_s1_translator:uav_write
	wire   [2:0] sseg_v_vi_s1_agent_m0_burstcount;                                                   // sseg_v_vi_s1_agent:m0_burstcount -> sseg_v_vi_s1_translator:uav_burstcount
	wire         sseg_v_vi_s1_agent_rf_source_valid;                                                 // sseg_v_vi_s1_agent:rf_source_valid -> sseg_v_vi_s1_agent_rsp_fifo:in_valid
	wire  [99:0] sseg_v_vi_s1_agent_rf_source_data;                                                  // sseg_v_vi_s1_agent:rf_source_data -> sseg_v_vi_s1_agent_rsp_fifo:in_data
	wire         sseg_v_vi_s1_agent_rf_source_ready;                                                 // sseg_v_vi_s1_agent_rsp_fifo:in_ready -> sseg_v_vi_s1_agent:rf_source_ready
	wire         sseg_v_vi_s1_agent_rf_source_startofpacket;                                         // sseg_v_vi_s1_agent:rf_source_startofpacket -> sseg_v_vi_s1_agent_rsp_fifo:in_startofpacket
	wire         sseg_v_vi_s1_agent_rf_source_endofpacket;                                           // sseg_v_vi_s1_agent:rf_source_endofpacket -> sseg_v_vi_s1_agent_rsp_fifo:in_endofpacket
	wire         sseg_v_vi_s1_agent_rsp_fifo_out_valid;                                              // sseg_v_vi_s1_agent_rsp_fifo:out_valid -> sseg_v_vi_s1_agent:rf_sink_valid
	wire  [99:0] sseg_v_vi_s1_agent_rsp_fifo_out_data;                                               // sseg_v_vi_s1_agent_rsp_fifo:out_data -> sseg_v_vi_s1_agent:rf_sink_data
	wire         sseg_v_vi_s1_agent_rsp_fifo_out_ready;                                              // sseg_v_vi_s1_agent:rf_sink_ready -> sseg_v_vi_s1_agent_rsp_fifo:out_ready
	wire         sseg_v_vi_s1_agent_rsp_fifo_out_startofpacket;                                      // sseg_v_vi_s1_agent_rsp_fifo:out_startofpacket -> sseg_v_vi_s1_agent:rf_sink_startofpacket
	wire         sseg_v_vi_s1_agent_rsp_fifo_out_endofpacket;                                        // sseg_v_vi_s1_agent_rsp_fifo:out_endofpacket -> sseg_v_vi_s1_agent:rf_sink_endofpacket
	wire         cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> sseg_v_vi_s1_agent:cp_valid
	wire  [98:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> sseg_v_vi_s1_agent:cp_data
	wire         cmd_mux_008_src_ready;                                                              // sseg_v_vi_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire   [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> sseg_v_vi_s1_agent:cp_channel
	wire         cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> sseg_v_vi_s1_agent:cp_startofpacket
	wire         cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> sseg_v_vi_s1_agent:cp_endofpacket
	...
	wire         audio_codec_avalon_audio_slave_agent_rp_valid;                                      // audio_codec_avalon_audio_slave_agent:rp_valid -> router_002:sink_valid
	wire  [98:0] audio_codec_avalon_audio_slave_agent_rp_data;                                       // audio_codec_avalon_audio_slave_agent:rp_data -> router_002:sink_data
	wire         audio_codec_avalon_audio_slave_agent_rp_ready;                                      // router_002:sink_ready -> audio_codec_avalon_audio_slave_agent:rp_ready
	wire         audio_codec_avalon_audio_slave_agent_rp_startofpacket;                              // audio_codec_avalon_audio_slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire         audio_codec_avalon_audio_slave_agent_rp_endofpacket;                                // audio_codec_avalon_audio_slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire  [98:0] sysid_qsys_0_control_slave_agent_rp_data;                                           // sysid_qsys_0_control_slave_agent:rp_data -> router_005:sink_data
	...
	wire  [98:0] nios2_gen2_0_debug_mem_slave_agent_rp_data;                                         // nios2_gen2_0_debug_mem_slave_agent:rp_data -> router_006:sink_data
	...
	wire  [98:0] onchip_memory2_0_s1_agent_rp_data;                                                  // onchip_memory2_0_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [98:0] buttons_s1_agent_rp_data;                                                           // buttons_s1_agent:rp_data -> router_008:sink_data
	...
	wire         sseg_i_iv_s1_agent_rp_valid;                                                        // sseg_i_iv_s1_agent:rp_valid -> router_009:sink_valid
	wire  [98:0] sseg_i_iv_s1_agent_rp_data;                                                         // sseg_i_iv_s1_agent:rp_data -> router_009:sink_data
	wire         sseg_i_iv_s1_agent_rp_ready;                                                        // router_009:sink_ready -> sseg_i_iv_s1_agent:rp_ready
	wire         sseg_i_iv_s1_agent_rp_startofpacket;                                                // sseg_i_iv_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire         sseg_i_iv_s1_agent_rp_endofpacket;                                                  // sseg_i_iv_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire         sseg_v_vi_s1_agent_rp_valid;                                                        // sseg_v_vi_s1_agent:rp_valid -> router_010:sink_valid
	wire  [98:0] sseg_v_vi_s1_agent_rp_data;                                                         // sseg_v_vi_s1_agent:rp_data -> router_010:sink_data
	wire         sseg_v_vi_s1_agent_rp_ready;                                                        // router_010:sink_ready -> sseg_v_vi_s1_agent:rp_ready
	wire         sseg_v_vi_s1_agent_rp_startofpacket;                                                // sseg_v_vi_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire         sseg_v_vi_s1_agent_rp_endofpacket;                                                  // sseg_v_vi_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire         audio_codec_avalon_audio_slave_agent_rdata_fifo_out_valid;                          // audio_codec_avalon_audio_slave_agent_rdata_fifo:out_valid -> avalon_st_adapter:in_0_valid
	wire  [33:0] audio_codec_avalon_audio_slave_agent_rdata_fifo_out_data;                           // audio_codec_avalon_audio_slave_agent_rdata_fifo:out_data -> avalon_st_adapter:in_0_data
	wire         audio_codec_avalon_audio_slave_agent_rdata_fifo_out_ready;                          // avalon_st_adapter:in_0_ready -> audio_codec_avalon_audio_slave_agent_rdata_fifo:out_ready
	wire         avalon_st_adapter_out_0_valid;                                                      // avalon_st_adapter:out_0_valid -> audio_codec_avalon_audio_slave_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_out_0_data;                                                       // avalon_st_adapter:out_0_data -> audio_codec_avalon_audio_slave_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_out_0_ready;                                                      // audio_codec_avalon_audio_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire   [0:0] avalon_st_adapter_out_0_error;                                                      // avalon_st_adapter:out_0_error -> audio_codec_avalon_audio_slave_agent:rdata_fifo_sink_error
	...
	wire         sseg_i_iv_s1_agent_rdata_fifo_src_valid;                                            // sseg_i_iv_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire  [33:0] sseg_i_iv_s1_agent_rdata_fifo_src_data;                                             // sseg_i_iv_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire         sseg_i_iv_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_007:in_0_ready -> sseg_i_iv_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> sseg_i_iv_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> sseg_i_iv_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_007_out_0_ready;                                                  // sseg_i_iv_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire   [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> sseg_i_iv_s1_agent:rdata_fifo_sink_error
	wire         sseg_v_vi_s1_agent_rdata_fifo_src_valid;                                            // sseg_v_vi_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire  [33:0] sseg_v_vi_s1_agent_rdata_fifo_src_data;                                             // sseg_v_vi_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire         sseg_v_vi_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_008:in_0_ready -> sseg_v_vi_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> sseg_v_vi_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> sseg_v_vi_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_008_out_0_ready;                                                  // sseg_v_vi_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire   [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> sseg_v_vi_s1_agent:rdata_fifo_sink_error
	...
	) audio_codec_avalon_audio_slave_translator (
		.clk                    (clock_bridge_0_out_clk_clk),                            //                      clk.clk
		.reset                  (audio_codec_reset_reset_bridge_in_reset_reset),         //                    reset.reset
		.uav_address            (audio_codec_avalon_audio_slave_agent_m0_address),       // avalon_universal_slave_0.address
		.uav_burstcount         (audio_codec_avalon_audio_slave_agent_m0_burstcount),    //                         .burstcount
		.uav_read               (audio_codec_avalon_audio_slave_agent_m0_read),          //                         .read
		.uav_write              (audio_codec_avalon_audio_slave_agent_m0_write),         //                         .write
		.uav_waitrequest        (audio_codec_avalon_audio_slave_agent_m0_waitrequest),   //                         .waitrequest
		.uav_readdatavalid      (audio_codec_avalon_audio_slave_agent_m0_readdatavalid), //                         .readdatavalid
		.uav_byteenable         (audio_codec_avalon_audio_slave_agent_m0_byteenable),    //                         .byteenable
		.uav_readdata           (audio_codec_avalon_audio_slave_agent_m0_readdata),      //                         .readdata
		.uav_writedata          (audio_codec_avalon_audio_slave_agent_m0_writedata),     //                         .writedata
		.uav_lock               (audio_codec_avalon_audio_slave_agent_m0_lock),          //                         .lock
		.uav_debugaccess        (audio_codec_avalon_audio_slave_agent_m0_debugaccess),   //                         .debugaccess
		.av_address             (audio_codec_avalon_audio_slave_address),                //      avalon_anti_slave_0.address
		.av_write               (audio_codec_avalon_audio_slave_write),                  //                         .write
		.av_read                (audio_codec_avalon_audio_slave_read),                   //                         .read
		.av_readdata            (audio_codec_avalon_audio_slave_readdata),               //                         .readdata
		.av_writedata           (audio_codec_avalon_audio_slave_writedata),              //                         .writedata
		.av_chipselect          (audio_codec_avalon_audio_slave_chipselect),             //                         .chipselect
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) sseg_i_iv_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (sseg_i_iv_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (sseg_i_iv_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (sseg_i_iv_s1_agent_m0_read),                     //                         .read
		.uav_write              (sseg_i_iv_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (sseg_i_iv_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (sseg_i_iv_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (sseg_i_iv_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (sseg_i_iv_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (sseg_i_iv_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (sseg_i_iv_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (sseg_i_iv_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (sseg_i_iv_s1_address),                           //      avalon_anti_slave_0.address
		.av_write               (sseg_i_iv_s1_write),                             //                         .write
		.av_readdata            (sseg_i_iv_s1_readdata),                          //                         .readdata
		.av_writedata           (sseg_i_iv_s1_writedata),                         //                         .writedata
		.av_chipselect          (sseg_i_iv_s1_chipselect),                        //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_translator #(
		...
		.AV_SETUP_WAIT_CYCLES           (0),
		.AV_DATA_HOLD_CYCLES            (0)
	) sseg_v_vi_s1_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (sseg_v_vi_s1_agent_m0_address),                  // avalon_universal_slave_0.address
		.uav_burstcount         (sseg_v_vi_s1_agent_m0_burstcount),               //                         .burstcount
		.uav_read               (sseg_v_vi_s1_agent_m0_read),                     //                         .read
		.uav_write              (sseg_v_vi_s1_agent_m0_write),                    //                         .write
		.uav_waitrequest        (sseg_v_vi_s1_agent_m0_waitrequest),              //                         .waitrequest
		.uav_readdatavalid      (sseg_v_vi_s1_agent_m0_readdatavalid),            //                         .readdatavalid
		.uav_byteenable         (sseg_v_vi_s1_agent_m0_byteenable),               //                         .byteenable
		.uav_readdata           (sseg_v_vi_s1_agent_m0_readdata),                 //                         .readdata
		.uav_writedata          (sseg_v_vi_s1_agent_m0_writedata),                //                         .writedata
		.uav_lock               (sseg_v_vi_s1_agent_m0_lock),                     //                         .lock
		.uav_debugaccess        (sseg_v_vi_s1_agent_m0_debugaccess),              //                         .debugaccess
		.av_address             (sseg_v_vi_s1_address),                           //      avalon_anti_slave_0.address
		.av_write               (sseg_v_vi_s1_write),                             //                         .write
		.av_readdata            (sseg_v_vi_s1_readdata),                          //                         .readdata
		.av_writedata           (sseg_v_vi_s1_writedata),                         //                         .writedata
		.av_chipselect          (sseg_v_vi_s1_chipselect),                        //                         .chipselect
		.av_read                (),                                               //              (terminated)
		.av_begintransfer       (),                                               //              (terminated)
		.av_beginbursttransfer  (),                                               //              (terminated)
		.av_burstcount          (),                                               //              (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) audio_codec_avalon_audio_slave_agent (
		.clk                     (clock_bridge_0_out_clk_clk),                                      //             clk.clk
		.reset                   (audio_codec_reset_reset_bridge_in_reset_reset),                   //       clk_reset.reset
		.m0_address              (audio_codec_avalon_audio_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (audio_codec_avalon_audio_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (audio_codec_avalon_audio_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (audio_codec_avalon_audio_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (audio_codec_avalon_audio_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (audio_codec_avalon_audio_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (audio_codec_avalon_audio_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (audio_codec_avalon_audio_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (audio_codec_avalon_audio_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (audio_codec_avalon_audio_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (audio_codec_avalon_audio_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (audio_codec_avalon_audio_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (audio_codec_avalon_audio_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (audio_codec_avalon_audio_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (audio_codec_avalon_audio_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (audio_codec_avalon_audio_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (audio_codec_avalon_audio_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (audio_codec_avalon_audio_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (audio_codec_avalon_audio_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (audio_codec_avalon_audio_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (audio_codec_avalon_audio_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (audio_codec_avalon_audio_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (audio_codec_avalon_audio_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (audio_codec_avalon_audio_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (audio_codec_avalon_audio_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (audio_codec_avalon_audio_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                                   // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                                   //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                                    //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                                   //                .error
		.rdata_fifo_src_ready    (audio_codec_avalon_audio_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (audio_codec_avalon_audio_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (audio_codec_avalon_audio_slave_agent_rdata_fifo_src_data),        //                .data
	...
	) audio_codec_avalon_audio_slave_agent_rsp_fifo (
		.clk               (clock_bridge_0_out_clk_clk),                                      //       clk.clk
		.reset             (audio_codec_reset_reset_bridge_in_reset_reset),                   // clk_reset.reset
		.in_data           (audio_codec_avalon_audio_slave_agent_rf_source_data),             //        in.data
		.in_valid          (audio_codec_avalon_audio_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (audio_codec_avalon_audio_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (audio_codec_avalon_audio_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (audio_codec_avalon_audio_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (audio_codec_avalon_audio_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (audio_codec_avalon_audio_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (audio_codec_avalon_audio_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (audio_codec_avalon_audio_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (audio_codec_avalon_audio_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) audio_codec_avalon_audio_slave_agent_rdata_fifo (
		.clk               (clock_bridge_0_out_clk_clk),                                //       clk.clk
		.reset             (audio_codec_reset_reset_bridge_in_reset_reset),             // clk_reset.reset
		.in_data           (audio_codec_avalon_audio_slave_agent_rdata_fifo_src_data),  //        in.data
		.in_valid          (audio_codec_avalon_audio_slave_agent_rdata_fifo_src_valid), //          .valid
		.in_ready          (audio_codec_avalon_audio_slave_agent_rdata_fifo_src_ready), //          .ready
		.out_data          (audio_codec_avalon_audio_slave_agent_rdata_fifo_out_data),  //       out.data
		.out_valid         (audio_codec_avalon_audio_slave_agent_rdata_fifo_out_valid), //          .valid
		.out_ready         (audio_codec_avalon_audio_slave_agent_rdata_fifo_out_ready), //          .ready
		.csr_address       (2'b00),                                                     // (terminated)
		.csr_read          (1'b0),                                                      // (terminated)
		.csr_write         (1'b0),                                                      // (terminated)
		.csr_readdata      (),                                                          // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (sseg_i_iv_s1_agent_m0_address),                  //              m0.address
		.m0_burstcount           (sseg_i_iv_s1_agent_m0_burstcount),               //                .burstcount
		.m0_byteenable           (sseg_i_iv_s1_agent_m0_byteenable),               //                .byteenable
		.m0_debugaccess          (sseg_i_iv_s1_agent_m0_debugaccess),              //                .debugaccess
		.m0_lock                 (sseg_i_iv_s1_agent_m0_lock),                     //                .lock
		.m0_readdata             (sseg_i_iv_s1_agent_m0_readdata),                 //                .readdata
		.m0_readdatavalid        (sseg_i_iv_s1_agent_m0_readdatavalid),            //                .readdatavalid
		.m0_read                 (sseg_i_iv_s1_agent_m0_read),                     //                .read
		.m0_waitrequest          (sseg_i_iv_s1_agent_m0_waitrequest),              //                .waitrequest
		.m0_writedata            (sseg_i_iv_s1_agent_m0_writedata),                //                .writedata
		.m0_write                (sseg_i_iv_s1_agent_m0_write),                    //                .write
		.rp_endofpacket          (sseg_i_iv_s1_agent_rp_endofpacket),              //              rp.endofpacket
		.rp_ready                (sseg_i_iv_s1_agent_rp_ready),                    //                .ready
		.rp_valid                (sseg_i_iv_s1_agent_rp_valid),                    //                .valid
		.rp_data                 (sseg_i_iv_s1_agent_rp_data),                     //                .data
		.rp_startofpacket        (sseg_i_iv_s1_agent_rp_startofpacket),            //                .startofpacket
		...
		.rf_sink_ready           (sseg_i_iv_s1_agent_rsp_fifo_out_ready),          //         rf_sink.ready
		.rf_sink_valid           (sseg_i_iv_s1_agent_rsp_fifo_out_valid),          //                .valid
		.rf_sink_startofpacket   (sseg_i_iv_s1_agent_rsp_fifo_out_startofpacket),  //                .startofpacket
		.rf_sink_endofpacket     (sseg_i_iv_s1_agent_rsp_fifo_out_endofpacket),    //                .endofpacket
		.rf_sink_data            (sseg_i_iv_s1_agent_rsp_fifo_out_data),           //                .data
		.rf_source_ready         (sseg_i_iv_s1_agent_rf_source_ready),             //       rf_source.ready
		.rf_source_valid         (sseg_i_iv_s1_agent_rf_source_valid),             //                .valid
		.rf_source_startofpacket (sseg_i_iv_s1_agent_rf_source_startofpacket),     //                .startofpacket
		.rf_source_endofpacket   (sseg_i_iv_s1_agent_rf_source_endofpacket),       //                .endofpacket
		.rf_source_data          (sseg_i_iv_s1_agent_rf_source_data),              //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_007_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_007_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_007_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_007_out_0_error),              //                .error
		.rdata_fifo_src_ready    (sseg_i_iv_s1_agent_rdata_fifo_src_ready),        //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sseg_i_iv_s1_agent_rdata_fifo_src_valid),        //                .valid
		.rdata_fifo_src_data     (sseg_i_iv_s1_agent_rdata_fifo_src_data),         //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sseg_i_iv_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (sseg_i_iv_s1_agent_rf_source_data),              //        in.data
		.in_valid          (sseg_i_iv_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (sseg_i_iv_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (sseg_i_iv_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (sseg_i_iv_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (sseg_i_iv_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (sseg_i_iv_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (sseg_i_iv_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (sseg_i_iv_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (sseg_i_iv_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	altera_merlin_slave_agent #(
		...
		.clk                     (clk_0_clk_clk),                                  //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //       clk_reset.reset
		.m0_address              (sseg_v_vi_s1_agent_m0_address),                  //              m0.address
		.m0_burstcount           (sseg_v_vi_s1_agent_m0_burstcount),               //                .burstcount
		.m0_byteenable           (sseg_v_vi_s1_agent_m0_byteenable),               //                .byteenable
		.m0_debugaccess          (sseg_v_vi_s1_agent_m0_debugaccess),              //                .debugaccess
		.m0_lock                 (sseg_v_vi_s1_agent_m0_lock),                     //                .lock
		.m0_readdata             (sseg_v_vi_s1_agent_m0_readdata),                 //                .readdata
		.m0_readdatavalid        (sseg_v_vi_s1_agent_m0_readdatavalid),            //                .readdatavalid
		.m0_read                 (sseg_v_vi_s1_agent_m0_read),                     //                .read
		.m0_waitrequest          (sseg_v_vi_s1_agent_m0_waitrequest),              //                .waitrequest
		.m0_writedata            (sseg_v_vi_s1_agent_m0_writedata),                //                .writedata
		.m0_write                (sseg_v_vi_s1_agent_m0_write),                    //                .write
		.rp_endofpacket          (sseg_v_vi_s1_agent_rp_endofpacket),              //              rp.endofpacket
		.rp_ready                (sseg_v_vi_s1_agent_rp_ready),                    //                .ready
		.rp_valid                (sseg_v_vi_s1_agent_rp_valid),                    //                .valid
		.rp_data                 (sseg_v_vi_s1_agent_rp_data),                     //                .data
		.rp_startofpacket        (sseg_v_vi_s1_agent_rp_startofpacket),            //                .startofpacket
		...
		.rf_sink_ready           (sseg_v_vi_s1_agent_rsp_fifo_out_ready),          //         rf_sink.ready
		.rf_sink_valid           (sseg_v_vi_s1_agent_rsp_fifo_out_valid),          //                .valid
		.rf_sink_startofpacket   (sseg_v_vi_s1_agent_rsp_fifo_out_startofpacket),  //                .startofpacket
		.rf_sink_endofpacket     (sseg_v_vi_s1_agent_rsp_fifo_out_endofpacket),    //                .endofpacket
		.rf_sink_data            (sseg_v_vi_s1_agent_rsp_fifo_out_data),           //                .data
		.rf_source_ready         (sseg_v_vi_s1_agent_rf_source_ready),             //       rf_source.ready
		.rf_source_valid         (sseg_v_vi_s1_agent_rf_source_valid),             //                .valid
		.rf_source_startofpacket (sseg_v_vi_s1_agent_rf_source_startofpacket),     //                .startofpacket
		.rf_source_endofpacket   (sseg_v_vi_s1_agent_rf_source_endofpacket),       //                .endofpacket
		.rf_source_data          (sseg_v_vi_s1_agent_rf_source_data),              //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_008_out_0_ready),              // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_008_out_0_valid),              //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_008_out_0_data),               //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_008_out_0_error),              //                .error
		.rdata_fifo_src_ready    (sseg_v_vi_s1_agent_rdata_fifo_src_ready),        //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (sseg_v_vi_s1_agent_rdata_fifo_src_valid),        //                .valid
		.rdata_fifo_src_data     (sseg_v_vi_s1_agent_rdata_fifo_src_data),         //                .data
		.m0_response             (2'b00),                                          //     (terminated)
		.m0_writeresponsevalid   (1'b0)                                            //     (terminated)
	);
	...
	altera_avalon_sc_fifo #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) sseg_v_vi_s1_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                  //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
		.in_data           (sseg_v_vi_s1_agent_rf_source_data),              //        in.data
		.in_valid          (sseg_v_vi_s1_agent_rf_source_valid),             //          .valid
		.in_ready          (sseg_v_vi_s1_agent_rf_source_ready),             //          .ready
		.in_startofpacket  (sseg_v_vi_s1_agent_rf_source_startofpacket),     //          .startofpacket
		.in_endofpacket    (sseg_v_vi_s1_agent_rf_source_endofpacket),       //          .endofpacket
		.out_data          (sseg_v_vi_s1_agent_rsp_fifo_out_data),           //       out.data
		.out_valid         (sseg_v_vi_s1_agent_rsp_fifo_out_valid),          //          .valid
		.out_ready         (sseg_v_vi_s1_agent_rsp_fifo_out_ready),          //          .ready
		.out_startofpacket (sseg_v_vi_s1_agent_rsp_fifo_out_startofpacket),  //          .startofpacket
		.out_endofpacket   (sseg_v_vi_s1_agent_rsp_fifo_out_endofpacket),    //          .endofpacket
		.csr_address       (2'b00),                                          // (terminated)
		.csr_read          (1'b0),                                           // (terminated)
		.csr_write         (1'b0),                                           // (terminated)
		.csr_readdata      (),                                               // (terminated)
	...
	system_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (audio_codec_avalon_audio_slave_agent_rp_ready),         //      sink.ready
		.sink_valid         (audio_codec_avalon_audio_slave_agent_rp_valid),         //          .valid
		.sink_data          (audio_codec_avalon_audio_slave_agent_rp_data),          //          .data
		.sink_startofpacket (audio_codec_avalon_audio_slave_agent_rp_startofpacket), //          .startofpacket
		.sink_endofpacket   (audio_codec_avalon_audio_slave_agent_rp_endofpacket),   //          .endofpacket
		.clk                (clock_bridge_0_out_clk_clk),                            //       clk.clk
		.reset              (audio_codec_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
	...
	system_mm_interconnect_0_router_002 router_009 (
		.sink_ready         (sseg_i_iv_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (sseg_i_iv_s1_agent_rp_valid),                    //          .valid
		.sink_data          (sseg_i_iv_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (sseg_i_iv_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (sseg_i_iv_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	system_mm_interconnect_0_router_002 router_010 (
		.sink_ready         (sseg_v_vi_s1_agent_rp_ready),                    //      sink.ready
		.sink_valid         (sseg_v_vi_s1_agent_rp_valid),                    //          .valid
		.sink_data          (sseg_v_vi_s1_agent_rp_data),                     //          .data
		.sink_startofpacket (sseg_v_vi_s1_agent_rp_startofpacket),            //          .startofpacket
		.sink_endofpacket   (sseg_v_vi_s1_agent_rp_endofpacket),              //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.out_reset         (audio_codec_reset_reset_bridge_in_reset_reset),  // out_clk_reset.reset
	...
	altera_avalon_st_handshake_clock_crosser #(
		...
		.in_reset          (audio_codec_reset_reset_bridge_in_reset_reset),  //  in_clk_reset.reset
	...
	system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_rst_0_reset (audio_codec_reset_reset_bridge_in_reset_reset),             // in_rst_0.reset
		.in_0_data      (audio_codec_avalon_audio_slave_agent_rdata_fifo_out_data),  //     in_0.data
		.in_0_valid     (audio_codec_avalon_audio_slave_agent_rdata_fifo_out_valid), //         .valid
		.in_0_ready     (audio_codec_avalon_audio_slave_agent_rdata_fifo_out_ready), //         .ready
	...
	system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (sseg_i_iv_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (sseg_i_iv_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (sseg_i_iv_s1_agent_rdata_fifo_src_ready),        //         .ready
	...
	system_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_clk_0_clk   (clk_0_clk_clk),                                  // in_clk_0.clk
		.in_rst_0_reset (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
		.in_0_data      (sseg_v_vi_s1_agent_rdata_fifo_src_data),         //     in_0.data
		.in_0_valid     (sseg_v_vi_s1_agent_rdata_fifo_src_valid),        //         .valid
		.in_0_ready     (sseg_v_vi_s1_agent_rdata_fifo_src_ready),        //         .ready
